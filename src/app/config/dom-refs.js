export function getDomRefs() {
  return {
    ...
    visualFeedbackToggle: document.querySelector("#visual-feedback-toggle"),
    visualFeedbackOpenButtons: document.querySelectorAll("[data-open-visual-feedback]"),
    ...
    overviewUrinalPanel: document.querySelector("#overview-urinal-panel"),
    ...
    visualFeedbackSubtitle: document.querySelector("#visual-feedback-subtitle"),
    visualFeedbackForm: document.querySelector("#visual-feedback-form"),
    visualFeedbackComment: document.querySelector("#visual-feedback-comment"),
    visualFeedbackList: document.querySelector("#visual-feedback-list"),
    visualFeedbackSummary: document.querySelector("#visual-feedback-summary"),
