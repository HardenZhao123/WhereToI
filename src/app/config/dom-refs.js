export function getDomRefs() {
  return {
    ...
    visualFeedbackStatus: document.querySelector("#visual-feedback-status"),
    ...
    overviewVisualLabel: document.querySelector("#overview-visual-label"),
    overviewVisualTone: document.querySelector("#overview-visual-tone"),
    overviewVisualFrame: document.querySelector("#overview-visual-frame"),
