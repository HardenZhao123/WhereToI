...
const visualDetailTabIndex = html.indexOf("data-detail-section=\"features\"");
const visualDetailPanelIndex = html.indexOf("id=\"details-features-panel\"");
...
if (
  ...
  !js.includes("setDetailSection(\"features\")") ||
  ...
  throw new Error("Expected visual cleanliness feedback to use an adjustable toilet image and an Overview detail tab with real image thumbnails.");
}
