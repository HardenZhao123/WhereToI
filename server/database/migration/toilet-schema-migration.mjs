...
const TOILET_SUBMISSION_COLUMNS = [
  ...
  { name: "submission_ocr_status", sqliteDefinition: "TEXT NOT NULL DEFAULT 'not_requested'", postgresDefinition: "TEXT NOT NULL DEFAULT 'not_requested'" },
  { name: "submission_ocr_provider", sqliteDefinition: "TEXT", postgresDefinition: "TEXT" },
  { name: "submission_ocr_text", sqliteDefinition: "TEXT", postgresDefinition: "TEXT" },
  { name: "submission_ocr_lines", sqliteDefinition: "TEXT NOT NULL DEFAULT '[]'", postgresDefinition: "JSONB NOT NULL DEFAULT '[]'::jsonb" },
  { name: "submission_ocr_keywords", sqliteDefinition: "TEXT NOT NULL DEFAULT '[]'", postgresDefinition: "JSONB NOT NULL DEFAULT '[]'::jsonb" },
  { name: "submission_ocr_opening_hours", sqliteDefinition: "TEXT NOT NULL DEFAULT '[]'", postgresDefinition: "JSONB NOT NULL DEFAULT '[]'::jsonb" },
  { name: "submission_ocr_confidence", sqliteDefinition: "REAL", postgresDefinition: "DOUBLE PRECISION" },
  { name: "submission_ocr_error", sqliteDefinition: "TEXT", postgresDefinition: "TEXT" },
  { name: "submission_ocr_checked_at", sqliteDefinition: "TEXT", postgresDefinition: "TEXT" },
    ...
    if (needsToiletsRebuild) {
      db.exec(`
        ...
        INSERT INTO toilets (
          ...
          submission_ocr_status, submission_ocr_provider, submission_ocr_text,
          submission_ocr_lines, submission_ocr_keywords, submission_ocr_opening_hours,
          submission_ocr_confidence, submission_ocr_error, submission_ocr_checked_at,
        ...
        SELECT
          ...
          submission_location_accuracy_metres, submission_location_distance_metres,
          submission_location_captured_at,
          COALESCE(submission_ocr_status, 'not_requested'), submission_ocr_provider, submission_ocr_text,
          COALESCE(submission_ocr_lines, '[]'), COALESCE(submission_ocr_keywords, '[]'), COALESCE(submission_ocr_opening_hours, '[]'),
          submission_ocr_confidence, submission_ocr_error, submission_ocr_checked_at,
          reviewed_by_user_id, reviewed_at, review_note, cleanliness, cleanliness_yes_count, cleanliness_no_count,
          cleanliness_rating_total, cleanliness_rating_count, cleanliness_rating_sum_squares, bias
